...
A Python-based mini NIDS project that captures live traffic, detects suspicious behavior, logs alerts, and generates end-of-run reports with graphs.
...
## Preview
Traffic analytics generated by the tool:

![Traffic Graphs](reports/traffic_graphs_v2.png)
